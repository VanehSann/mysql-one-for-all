...
-- album_id, artist_id, album_name e release_year
CREATE TABLE SpotifyClone.albums(
    album_id INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    album_name CHAR(20) NOT NULL,
    release_year CHAR(20) NOT NULL,
    artist_id INT NOT NULL,
    FOREIGN KEY (artist_id) REFERENCES artists(artist_id)
) engine = InnoDB;

-- criando tabela de songs
-- album_id, song_name
-- song_duration
...
-- criando tabela de reproductions_history
-- song_id, user_id e played_date
-- reproductions_history
CREATE TABLE SpotifyClone.reproductions_history(
    -- reproduction_history INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    played_date  CHAR(30) NOT NULL,
...
-- criando tabela de followed_artists
-- artist_id, user_id
-- followed_artist 
CREATE TABLE SpotifyClone.followed_artists(
    -- followed_artist INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    user_id INT NOT NULL,
    FOREIGN KEY (user_id) REFERENCES users(user_id),
    artist_id INT NOT NULL,
    FOREIGN KEY (artist_id) REFERENCES artists(artist_id),
...
INSERT INTO SpotifyClone.reproductions_history(user_id, song_id, played_date)
VALUES	
