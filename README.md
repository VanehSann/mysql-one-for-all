...
<p align="center"><b>
 ...
 <a href="#-mysql-one-for-all-project-------">README em Português 🇧🇷</a>
  </b>
</p>
<h1 align="center">
...
<table>
    <tr>
      <td><br>
        <p align="left"> O objetivo do projeto era criar queries para cada desafio e
        retorno proposto pelos requisitos e normalizar uma tableta na 3º forma normal. ( Funções SQL, Joins, Normalização e Queries )  </p> </td>
  </tr>
    <tr>
      <td><br>
        <p align="left">
...
Tecnologias utilizadas ( Hard Skills )
 ...
 <tr><td> 
  ...
  <tr><td> 
 - MySQL ( Funções SQL, Joins, Normalização e Queries ) 
 </td></tr>
    </table>
      </blockquote>
  </div>
